...
Additionally, the next step -started but not presentable would be to actually use our model to predict what are the expected future values for the price and the attractiveness of the cryptomoney XRP. 
